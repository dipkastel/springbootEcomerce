						...
						<div class="container-fluid">
							...
							<div class="card card-info card-outline">
								<form id="editUser"
									...
									method="post">
									<input type="hidden" id="id" name="id" value="${paymentEdit.id}">

									<div class="card-body">
										<div class="form-group row" style="">
											<label for="name"
												class="col-sm-2 col-form-label text-sm-right required">Payment Method</label>
										...
										<div class="form-group row" style="">
											<label for="email"
												class="col-sm-2 col-form-label text-sm-right required">Amount</label>
											<div class="col-xs-12 col-sm-8">
										...
										<div class="form-group row" style="">
											<label for="email"
												class="col-sm-2 col-form-label text-sm-right required">Payment Date</label>
											<div class="col-xs-12 col-sm-8">
												<input type="text" id="email" name="email"
													value="${paymentEdit.paymentDate}"
													class="form-control form-control-sm" disabled>
											</div>
										</div>
