                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add tag Form</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form id="frmType"
                                  action="${pageContext.servletContext.contextPath}/admin/tag/new"
                                  method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="slug" name="slug" placeholder="AutoGenerate" readonly="readonly" >
                                    </div>
                                    <div class="form-check" >
                                        <input type="checkbox" name="MasterTag" class="form-check-input" id="chk_mastertag">
                                        <label class="form-check-label" for="chk_mastertag">mastertag</label>
                                    </div>
                                    <div id="div_description" class="form-group" hidden>
                                        <label for="name">description</label>
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Enter description" maxlength="200">
