						...
						<div class="col-md-12">
							...
							<div class="card card-primary">
											...
											<div class="col-md-12">
												...
												<div class="form-group">
													<label for="images">Image</label> <br /> <input
														type="file" id="img" name="img" multiple="multiple">
								...
								<div class="card-footer">
									<button id="btnAddProduct" type="submit"
		...
		$('#btnAddProduct')
				.on(
						...
						function() {
							...
							} else if (!isInt(stockQuantity.val())) {
								hasSubmit.push(1);
								$('#stockQuantity').addClass(
										'form-control is-invalid');
								$('#stockQuantity-error').html(
							...
							if (!validate()) {
								...
								$('#img-successful').html('');
							} else if (totalSize > 8192000) {
								hasSubmit.push(1);
								$('#img-error').html(
										'Image size is not greater than 8MB!');
								$('#img-successful').html('');
							} else {
