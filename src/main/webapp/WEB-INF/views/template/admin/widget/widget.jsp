                ...
                <div class="col-12">
                    ...
                    <div class="card collapsed-card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">ویجت ها</h3>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-6">
                        <c:forEach items="${types}" var="m" varStatus="loop">

                            <c:choose>
                                <c:when test="${loop.index%2!=0}">

                                    <jsp:include page="_widget_list.jsp">
                                        <jsp:param name="pageName" value="${m}"/>
                                    </jsp:include>
                                </c:when>
                            </c:choose>
                        </c:forEach>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <form method="POST" enctype="multipart/form-data" id="formAddWidget"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <form method="POST" enctype="multipart/form-data" id="FormUpdateWidget"
...
<jsp:include page="js/script_common.jsp"/>
</body>
</html>
