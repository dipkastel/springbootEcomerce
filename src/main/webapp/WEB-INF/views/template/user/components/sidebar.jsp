            ...
            <div class="ps-cart__content">
                <div class="ps-product--cart-mobile">
                    <div class="ps-product__thumbnail"><a><img
                            src="${pageContext.servletContext.contextPath}/img/products/clothing/7.jpg" alt=""></a>
                    </div>
                    <div class="ps-product__content"><a class="ps-product__remove"><i class="icon-cross"></i></a><a
                            href="product-default.html">MVMTH Classical Leather Watch In Black</a>
                        <p><strong>فروشنده:</strong> بایچه</p><small>1 x $59.99</small>
                    </div>
                </div>
                <div class="ps-cart__footer">
                    <h3>Sub Total:<strong>$259.99</strong></h3>
                    <figure><a class="ps-btn" href="shopping-cart.html">View Cart</a><a class="ps-btn"
                                                                                        href="${pageContext.servletContext.contextPath}/customer/product/checkout">Checkout</a>
                    </figure>
                </div>
            </div>
...
<div class="ps-panel--sidebar" id="navigation-mobile">
    ...
    <div class="ps-panel__content">
        <ul class="menu--mobile">
            ...
            <li class="menu-item-has-children has-mega-menu"><a>Computer &amp; Technology</a><span
...
<div class="navigation--list">
    <div class="navigation__content">
        <a class="navigation__item ps-toggle--sidebar" href="#menu-mobile">
            <i class="icon-menu"></i><span> منو</span></a>
        <a class="navigation__item ps-toggle--sidebar" href="#navigation-mobile">
            <i class="icon-list4"></i><span> دسته بندی</span></a>
        <a class="navigation__item ps-toggle--sidebar" href="#search-sidebar">
            <i class="icon-magnifier"></i><span> جستجو</span></a>
        <a class="navigation__item ps-toggle--sidebar" href="#cart-mobile">
            <i class="icon-bag2"></i><span> سبد خرید</span></a>
    </div>
</div>
