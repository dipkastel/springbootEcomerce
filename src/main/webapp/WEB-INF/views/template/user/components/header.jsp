...
<%--                </div><a class="ps-logo" href="index.html"><img src="${pageContext.servletContext.contextPath}/img/logo_light.png" alt=""></a></div>--%>
    ...
    <div class="header__center">
                <form class="ps-form--quick-search" action="${pageContext.servletContext.contextPath}/product" method="post">
                    ...
                    <input class="form-control" type="text" placeholder="جستجو ..." id="input-search" name="keyword" maxlength="20">
                ...
                <div class="header__actions">
                        ...
                        <div class="ps-cart__content"  id="cart-content-1" style="display: none" >
                            <div class="ps-cart__items">
                                <div class="ps-product--cart-mobile">
                                    ...
                                    <div class="ps-product__content"><a class="ps-product__remove" ><i class="icon-cross "></i></a><a href="product-default.html">--</a>
                            ...
                            <div class="ps-cart__footer">
                                ...
                                <figure>
                                    <c:choose>
                                        <c:when test="${user !=null}">
                                            <a class="ps-btn" href="${pageContext.servletContext.contextPath}/customer/product/checkout-page">سبد خرید</a>

                                        </c:when>
                                        <c:otherwise>
                                            <a class="ps-btn" href="${pageContext.servletContext.contextPath}/cart">سبد خرید</a>
                                        </c:otherwise>
                                    </c:choose>
                                    <a class="ps-btn" href="${pageContext.servletContext.contextPath}/customer/product/checkout">صورت حساب</a></figure>
                            </div>
                        </div >
                    </div>
                    <div class="ps-block--user-header">
                        ...
                        <c:choose>
                            ...
                            <c:when test="${user !=null }">
                                ...
                                <ul class="navigation__extra">
                                    ...
                                    <ul class="ps-dropdown-menu" >
                                            <c:choose>
                                            <c:when test="${user.role  == 'ROLE_USER' }">
                                                <li ><a href="${pageContext.servletContext.contextPath}/customer/info">حساب کاربری</a></li>
                                            </c:when>
                                            <c:otherwise>
                                                <li ><a href="${pageContext.servletContext.contextPath}/admin">مدیریت</a></li>
                                            </c:otherwise>
                                            </c:choose>
                                                <li ><a href="${pageContext.servletContext.contextPath}/logout">خروج</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <c:otherwise>
                                <div class="ps-block__right"><a href="${pageContext.servletContext.contextPath}/login">ورود</a><a href="${pageContext.servletContext.contextPath}/register">ثبت نام</a></div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
        ...
        <div class="ps-container">
            <div class="navigation__right">
                ...
                <ul class="navigation__extra">
                    ...
                    <li><a href="${pageContext.servletContext.contextPath}/customer/product/checkout-page">پیگیری سفارشات</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="header__top">
        ...
        <div class="header__right">
            <ul class="navigation__extra">
                ...
                <li>
                    <div class="ps-dropdown language"><a ><img src="${pageContext.servletContext.contextPath}/img/flag/fa.png" alt="">فارسی</a>
                        <ul class="ps-dropdown-menu">
                            <li><a ><img src="${pageContext.servletContext.contextPath}/img/flag/fa.png" alt=""> فارسی</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
