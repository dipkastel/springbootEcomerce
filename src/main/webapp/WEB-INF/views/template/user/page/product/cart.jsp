        ...
        <div class="ps-section__content">
            <div class="table-responsive">
                <table class="table ps-table--shopping-cart ps-table--responsive">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <tr>
                                <td colspan="5" class="text-center"><h1>محصولی اضافه نشده !!!</h1></td>
                            </tr>
                        </c:otherwise>
                    </c:choose>
                    </tbody>
            ...
            <div class="ps-section__cart-actions">
                <c:if test="${cartItems !=null}">
                    ...
                    <a class="ps-btn ps-btn--outline hide-1" href="shop-default.html" style="display: none"><i class="icon-sync"></i> بروز رسانی</a>
...
//remove cart item
        ...
        function getTableShoppingCart(item) {
            ...
            if (item.length>0){
                ...
                table +="</div> </div> </td>"
                table +="<td class='price text-center' data-label='Price'>"+item[i].product.price+"تومان</td>"
