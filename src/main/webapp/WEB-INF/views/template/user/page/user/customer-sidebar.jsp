    ...
    <aside class="ps-widget--account-dashboard">
        ...
        <div class="ps-widget__content">
            <ul>
                ...
                <li class="${pageContext.request.requestURI.contains("/customer/product/checkout-page") ?"active":""}"><a href="${pageContext.servletContext.contextPath}/customer/product/checkout-page" ><i class="icon-alarm-ringing"></i> صورت حساب </a></li>
                ...
                <li class="${pageContext.request.requestURI.contains("/customer/recent") ?"active":""}"><a href="${pageContext.servletContext.contextPath}/customer/recent"><i class="icon-store"></i> بازدید های اخیر</a></li>
                ...
                <li class="${pageContext.request.requestURI.contains("/auth/change-password") ?"active":""}"><a href="${pageContext.servletContext.contextPath}/customer/password"><i class="icon-papers"></i> تغییر کلمه عبور</a></li>
