...
<div class="ps-section__left">
    <aside class="ps-widget--account-dashboard">
        <div class="ps-widget__header"><i class="icon-user"></i>
            <figure>
                <figcaption>${customerInfo.firstName} ${customerInfo.lastName} </figcaption>
        ...
        <div class="ps-widget__content">
            <ul>
                ...
                <li class="${pageContext.request.requestURI.contains("/customer/checkout-page") ?"active":""}"><a href="${pageContext.servletContext.contextPath}/customer/checkout-page" ><i class="icon-credit-card"></i> صورت حساب </a></li>
                <li class="${pageContext.request.requestURI.contains("/customer/addresses") ?"active":""}"><a href="${pageContext.servletContext.contextPath}/customer/addresses" ><i class="icon-map2"></i> آدرس ها </a></li>
